<?php
    ...
    $P3 = "We also wanted to thank you, we exist thanks to people like you !";
    $P4 = "You can claim \"Customer\" rank on our discord, all you have to do is open a ticket and make the request, it's very simple and fast to be able to bproudly display in client rank and you fart it with your friends (you still have to have some) !";
